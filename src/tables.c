...
const struct clan_type clan_table[MAX_CLAN] = {
    ...
    {"",      "",               ROOM_VNUM_SNAKEWAY,        TRUE},
    {"loner", "[ Loner ] ",     ROOM_VNUM_SNAKEWAY,        TRUE},
    {"Saiyan Fury",   "[{RSaiFury{x] ", ROOM_VNUM_SNAKEWAY,        FALSE}
};
...
const struct flag_type room_flags[] = {
	...
	{"high_gravity", ROOM_HIGHGRAVITY, TRUE},
    {"chaos", ROOM_CHAOS, TRUE},
    {NULL, 0, 0}
};
...
const struct flag_type extra_flags[] = {
	...
	{"needpl",      ITEM_NEED_PL, TRUE},
    {"nonmetal", ITEM_NONMETAL, TRUE},
    {"meltdrop", ITEM_MELT_DROP, TRUE},
    {"hadtimer", ITEM_HAD_TIMER, TRUE},
    {"sellextract", ITEM_SELL_EXTRACT, TRUE},
	{"indestructible", ITEM_INDESTRUCTIBLE, TRUE},
    {"burnproof", ITEM_BURN_PROOF, TRUE},
    {"nouncurse", ITEM_NOUNCURSE, TRUE},
	{"scouter", ITEM_SCOUTER, TRUE},
