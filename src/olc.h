...
DECLARE_OLC_FUN( medit_zenni		);  /* ROM */
...
DECLARE_OLC_FUN( medit_str		);  /* ROM */
DECLARE_OLC_FUN( medit_int		);  /* ROM */
DECLARE_OLC_FUN( medit_wil		);  /* ROM */
DECLARE_OLC_FUN( medit_dex		);  /* ROM */
DECLARE_OLC_FUN( medit_cha		);  /* ROM */
DECLARE_OLC_FUN( medit_hitbonus );
DECLARE_OLC_FUN( medit_kibonus );
